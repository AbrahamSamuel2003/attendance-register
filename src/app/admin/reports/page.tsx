  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-lg font-bold text-slate-900">Attendance Reports & Export</h1>
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-2 bg-white px-3 py-1.5 rounded-xl border border-slate-200 shadow-xs">
            ...
            <input
              ...
              className="text-xs text-slate-800 bg-transparent outline-none font-medium"
            />
          </div>

          <a
            href={`/api/reports/export-excel?date=${selectedDate}`}
            className="py-2 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs flex items-center space-x-2 shadow-xs transition-colors"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-xs">
          ...
          <span className="text-[10px] text-slate-500">Gross employee hours</span>
        </div>

        <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="text-xs font-medium">Avg Work / Employee</span>
            <Users className="w-4 h-4 text-emerald-600" />
          </div>
          <div className="text-2xl font-bold text-slate-900">{avgWorkHours}h</div>
          <span className="text-[10px] text-slate-500">Per present staff</span>
        </div>

        <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="text-xs font-medium">Total Break Time</span>
            <Coffee className="w-4 h-4 text-amber-600" />
          </div>
          <div className="text-2xl font-bold text-slate-900">{totalBreakMins + totalLunchMins}m</div>
          <span className="text-[10px] text-slate-500">Break + Lunch minutes</span>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-xs">
          ...
          <span className="text-[10px] text-rose-600 font-medium">After 09:45 AM</span>
        </div>
      </div>
