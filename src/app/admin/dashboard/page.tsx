      ...
      <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-3 w-full md:w-auto overflow-x-auto">
          <select
            ...
            className="px-3 py-2 rounded-xl light-input text-xs"
          >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 max-w-md w-full space-y-4 shadow-xl">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500">Today's sequential attendance events</p>
              </div>
              <button
                ...
                eventHistoryModal.todayEvents.map((ev, idx) => (
                  ...
                  >
                    <div>
                      ...
                      <span className="text-[10px] text-slate-500">{ev.notes || 'Normal mobile punch'}</span>
                    </div>
